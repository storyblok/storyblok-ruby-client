    ...
    context "With token defined" do
      ...
      context "When using a renderer" do
        ...
        context "When setting a renderer at client initialization" do
          subject {
            described_class.new(api_version: 1, token: token, version: version, component_resolver: component_resolver)
          }
      ...
      context "When caching is enabled", redis_cache: true do
        ...
        it "caches the tags list", :vcr do
          expect { subject.tags }.to change {
                                       redis_client.keys("storyblok:*").size
                                     }.from(0).to(2) # stores cache and cache_version
        ...
        it "flushes the cache", :vcr do
          ...
          expect { subject.flush }.to change {
                                        redis_client.get("storyblok:<SPACE_PUBLIC_TOKEN>:version")
                                      }.from('0') # generates the next_cache_version
          ...
          expect { subject.tags }.to change {
                                       redis_client.keys(next_cache_key_partial).size
                                     }.from(0).to(1) # generates the cache using the next_cache_version generated by flush
      ...
      context "When performing a GET request" do
        context "Listing spaces" do
          ...
          it "returns a space list", :vcr do
            expect(subject['data']).to eq({
                                            "spaces" => [
                                              { "name" => "Clean Space",     "id" => 91322, "euid" => nil,
                                                "owner_id" => "<OWNER_ID_INTEGER>" },
                                              { "name" => "blog_space",      "id" => 91112, "euid" => nil,
                                                "owner_id" => "<OWNER_ID_INTEGER>" },
                                              { "name" => "My beta Space",   "id" => 88422, "euid" => "",
                                                "owner_id" => "<OWNER_ID_INTEGER>" },
                                              { "name" => "My new Space",    "id" => 86092, "euid" => nil,
                                                "owner_id" => "<OWNER_ID_INTEGER>" },
                                              { "name" => "Your demo space", "id" => 85563, "euid" => nil,
                                                "owner_id" => "<OWNER_ID_INTEGER>" }
                                            ]
                                          })
          end
          ...
          it "creates a story", :vcr do
            ...
            expect(subject['data']).to eq({
                                            "story" => {
                                              ...
                                              "is_folder" => false,
                                              "content" => { "component" => "root", "body" => [],
                                                             "_uid" => "fa221d61-73ba-4435-82a9-26ac1cf4bf11" },
                                              "published" => false,
                                              ...
                                              "preview_token" => { "token" => "<PREVIEW_TOKEN>",
                                                                   "timestamp" => "1598372618" },
                                              "pinned" => false,
                                              "breadcrumbs" => [],
                                              "publish_at" => nil,
                                              "expire_at" => nil,
                                              "first_published_at" => nil,
                                              "last_author" => { "id" => "<OWNER_ID_INTEGER>", "userid" => "<MY_USER_EMAIL>",
                                                                 "friendly_name" => "<MY_USER_EMAIL>" },
                                              "user_ids" => [],
                                              "space_role_ids" => [],
                                              "translated_slugs" => [],
                                              "localized_paths" => [],
          ...
          it "updates a story", :vcr do
            ...
            expect(subject['data']).to eq({
                                            "story" => {
                                              ...
                                              "uuid" => "defee8f9-0704-4855-aebc-6d37908297ea",
                                              "is_folder" => false,
                                              "content" => { "_uid" => "fa221d61-73ba-4435-82a9-26ac1cf4bf11",
                                                             "body" => [], "component" => "root" },
                                              "published" => false,
                                              "slug" => "my-awesome-new-story",
                                              "path" => nil,
                                              ...
                                              "meta_data" => nil,
                                              "imported_at" => nil,
                                              "preview_token" => { "token" => "d5681a1d0e5d798582a0e6ed791c6bfa1f618e54",
                                                                   "timestamp" => "1598378584" },
                                              "pinned" => false,
                                              "breadcrumbs" => [],
                                              "publish_at" => nil,
                                              "expire_at" => nil,
          ...
          it "deletes a story", :vcr do
            ...
            expect(subject['data']).to eq({
                                            "story" => {
                                              ...
                                              "meta_data" => nil,
                                              "imported_at" => nil,
                                              "preview_token" => { "token" => "af676cb58efa328b9f6c30251b9212598c66d55b",
                                                                   "timestamp" => "1598378897" },
                                              "pinned" => false,
                                              "breadcrumbs" => [],
                                              "publish_at" => nil,
                                              "expire_at" => nil,
